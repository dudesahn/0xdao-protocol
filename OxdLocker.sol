...
import "@openzeppelin-3.4.0/contracts/token/ERC20/SafeERC20.sol";
import "@openzeppelin-3.4.0/contracts/math/Math.sol";
import "@openzeppelin-3.4.0/contracts/access/Ownable.sol";
import "@openzeppelin-3.4.0/contracts/utils/ReentrancyGuard.sol";
import "../rock/GovernableImplementation.sol";
import "../rock/ProxyImplementation.sol";
import "../rock/interfaces/IVotingSnapshot.sol";

/**
 * @title OXD Locking contract
 * @author Convex Finance / 0xDAO
 * @dev OXD locked in this contract will be entitled to voting rights for the 0xDAO platform
    ...
    ProxyImplementation
{
     ...
     */
    function initializeProxyStorage(address _rewardsDistributor, IERC20 _oxd)
        public
        checkProxyInitialized
    {
        // Re-entrancy guard has a constructor, but that one can be ignored.

        _name = "Vote Locked OXD";
        _symbol = "vlOXD";
